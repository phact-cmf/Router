...
Следует стандартам: PSR-7, PSR-15, а так же PSR-1, PSR-2, PSR-4, PSR-11, PSR-12, PSR-16
...
## Простейшее использование, как в FastRoute, но с возможностью reversed routing
